...
if __name__ == '__main__':
    ...
    output_graph_def = tf.graph_util.convert_variables_to_constants(sess, sess.graph.as_graph_def(), ['InceptionV1/rpn_cls_prob/transpose_1', 'InceptionV1/rpn_bbox_pred/BiasAdd', 'InceptionV1/cls_prob', 'add'])
    with tf.gfile.FastGFile('output_graph.pb', 'wb') as f:
        f.write(output_graph_def.SerializeToString())
        print ('write output_graph.pb finished')


    im_names = ['0003.png', '0004.png', '0005.png']
